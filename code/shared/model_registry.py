...
class LLMModels(str, Enum):
    ...
    # SAMBANOVA_DEEPSEEK_R1_DISTILL_QWEN_32B = "DeepSeek-R1-Distill-Qwen-32B"    # ❌ NOT AVAILABLE on SambaNova (returns "Model not found")
...
class ProviderPreset:
    ...
    SAMBANOVA_FAST = {
        ...
        "answer_complex": LLMModels.SAMBANOVA_LLAMA_70B.value, # Meta-Llama-3.3-70B-Instruct (no <think> tags!)
        ...
        "reranking": RerankingModels.JINA_RERANKER_V2_BASE.value, # jina-reranker-v2-base-multilingual
        "provider": "sambanova",
        "description": "SambaNova AI - Fast and FREE (Llama 70B for complex + Llama 8B)"
    }
...
LLM_CAPABILITIES = {
    ...
    LLMModels.QWEN_32B_FAST: {
        ...
        "cleaning_pattern": r'<think>.*?(?:</think>|$)'  # Handles both closed </think> and unclosed (truncated) tags
    },
    ...
    LLMModels.DEEPSEEK_R1: {
        ...
        "cost_tier": "high",
        "requires_cleaning": True,  # Must strip <think> reasoning tags from output
        "cleaning_pattern": r'<think>.*?(?:</think>|$)',  # Handles both closed and unclosed tags  # Use this regex pattern to clean output
        "provider": "nebius"
    },
    ...
    LLMModels.SAMBANOVA_DEEPSEEK_R1: {
        ...
        "cleaning_pattern": r'<think>.*?(?:</think>|$)',  # Handles both closed and unclosed tags
        "provider": "sambanova",
...
# ============================================================================
#
# ✅ FULLY TESTED - All 3 providers verified with complete ingestion pipeline (2025-10-17)
# Test document: JaiShreeRam.md (22 chunks)
# All collections created successfully in Milvus and viewable in Attu UI
#
# Test Results Summary:
#   1. Jina AI - jina-embeddings-v3 (1024 dims) - ✅ TESTED
#      Collection: jina_v3_test
#      Cost: $0.02/M tokens (most affordable)
#
#   2. Nebius AI - intfloat/e5-mistral-7b-instruct (4096 dims) - ✅ TESTED
#      Collection: nebius_e5_test
#      Cost: Paid (exact pricing TBD)
#
#   3. SambaNova AI - E5-Mistral-7B-Instruct (4096 dims) - ✅ TESTED
...
EMBEDDING_CAPABILITIES = {
    ...
    # SambaNova AI models (FREE tier) - ✅ FULLY TESTED 2025-10-17
...
def get_llm_for_task(task: str, complexity: str = "moderate", intent: str = None) -> str:
    ...
    if task == "intent_detection":
        ...
        if intent and intent in COMPLEX_INTENTS:
            ...
            print(f"[MODEL_REGISTRY DEBUG] Intent '{intent}' is COMPLEX. Returning DEFAULT_LLM_ANSWER_COMPLEX = {DEFAULT_LLM_ANSWER_COMPLEX}")
            return DEFAULT_LLM_ANSWER_COMPLEX
        elif intent:
            # Simple intent - use simple model from active preset
            print(f"[MODEL_REGISTRY DEBUG] Intent '{intent}' is SIMPLE. Returning DEFAULT_LLM_ANSWER_SIMPLE = {DEFAULT_LLM_ANSWER_SIMPLE}")
